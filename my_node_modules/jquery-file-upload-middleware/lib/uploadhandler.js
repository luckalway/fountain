...
module.exports = function (options) {
    ...
    UploadHandler.prototype.initUrls = function (fileInfo, cb) {
        fileInfo.setUrl(null, options.uploadUrl());
        fileInfo.setUrl('delete', this.req.originalUrl);
        fileInfo.setPath(path.join(options.uploadDir(), fileInfo.name));
        fileInfo.setUploadDir(options.uploadDir());
        async.each(Object.keys(options.imageVersions), function(version, cb) {
            fs.exists(options.uploadDir() + '/' + version + '/' + fileInfo.name, function(exists) {
                if (exists) fileInfo.setUrl(version, options.uploadUrl() + '/' + version);
                cb(null);
            })
        },
        cb);
